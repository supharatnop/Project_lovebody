...
namespace ProjectTest
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBox1.Text == "ออกกำลังกายปานกลางเล่นกีฬา 3-5 วัน/สัปดาห์")
            {
                total = 1.55 * se1;//ให้ total เก็บค่า 1.55 * se1
                textBox_TDEE.Text = total.ToString();//ให้ total แสดงที่ textBox_TDEE
            }
            else if (comboBox1.Text == "ออกกำลังกายหนักเล่นกีฬา 6-7 วัน/สัปดาห์")
            {
                total = 1.725 * se1;//ให้ total เก็บค่า 1.725 * se1
                textBox_TDEE.Text = total.ToString();//ให้ total แสดงที่ textBox_TDEE
            }
            else if (comboBox1.Text == "ออกกำลังกายหนักมากเป็นหนักกีฬา")
            {
